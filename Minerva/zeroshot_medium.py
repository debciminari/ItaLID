...
def build_prompt(frase):
    return f"""In quale lingua è scritta la seguente frase?
    Scegli una lingua tra le seguenti: corso, emiliano-romagnolo, italiano, lombardo, napoletano, piemontese, sardo, siciliano, veneto.
...
plt.tight_layout()
plt.savefig("confusion_matrix_minerva_zero_2.png", dpi=150)
plt.show()

# --- Save errors ---
with open("errors_minerva_zero_2.json", "w", encoding="utf-8") as f:
