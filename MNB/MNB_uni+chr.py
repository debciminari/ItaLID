## Multinomial Naive Bayes — char 5-gram + word unigram (1,1)
## FeatureUnion: CountVectorizer char (5,5) + CountVectorizer word (1,1)
...
print(f"\n{'='*50}")
print(f"  Modello: char 5-gram + word unigram")
print(f"{'='*50}")
